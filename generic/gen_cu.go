...
func BanChatMember[chatUnion ChatUnion](ctx *ext.Context, chat chatUnion, userId int64, untilDate int) (tg.UpdatesClass, error) {
	chatId, err := getIdByUnion(ctx, chat)
	if err != nil {
		return nil, err
	}
...
func UnbanChatMember[chatUnion ChatUnion](ctx *ext.Context, chat chatUnion, userId int64) (bool, error) {
	chatId, err := getIdByUnion(ctx, chat)
	if err != nil {
		return false, err
	}
...
func PromoteChatMember[chatUnion ChatUnion](ctx *ext.Context, chat chatUnion, userId int64, opts *ext.EditAdminOpts) (bool, error) {
	chatId, err := getIdByUnion(ctx, chat)
	if err != nil {
		return false, err
	}
...
func DemoteChatMember[chatUnion ChatUnion](ctx *ext.Context, chat chatUnion, userId int64, opts *ext.EditAdminOpts) (bool, error) {
	chatId, err := getIdByUnion(ctx, chat)
	if err != nil {
		return false, err
	}
